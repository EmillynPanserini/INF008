...
import br.edu.ifba.inf008.interfaces.IRequiresDatabaseService; // Importar IRequiresDatabaseService
import br.edu.ifba.inf008.interfaces.IDatabaseService; // Importar IDatabaseService
import java.io.File;
        ...
        try {
            ...
            for (i = 0; i < plugins.length; i++)
            {
                ...
                if (plugin instanceof IRequiresDatabaseService) {
                    IDatabaseService dbService = ICore.getInstance().getDatabaseService();
                    if (dbService == null) {
